...
public class HarleyDroidDashboardView implements HarleyDataDashboardListener, HarleyDataDiagnosticsListener
{
	...
	public void changeView(int viewMode, boolean portrait, boolean unitMetric) {
		...
		int view = R.layout.portrait_text;
	...
	public void onSpeedImperialChanged(int speed) {
		...
		Holder.shared().STORED_SPEED_IMPERIAL = speed;
	}
	...
	public void onSpeedMetricChanged(int speed) {
		...
		Holder.shared().STORED_SPEED_METRIC = speed;
	}
	...
	public void onEngineTempImperialChanged(int engineTemp) {
		...
		Holder.shared().STORED_ENGINETEMP_IMPERIAL = engineTemp;
	}
	...
	public void onEngineTempMetricChanged(int engineTemp) {
		...
		Holder.shared().STORED_ENGINETEMP_METRIC = engineTemp;
	}
	...
	public void onFuelGaugeChanged(int full, boolean low) {
		...
		Holder.shared().STORED_FUELGAUGE = full;
		Holder.shared().STORED_LOW_FUEL = low;
	}
	...
	public void onTurnSignalsChanged(int turnSignals) {
		...
		Holder.shared().STORED_TURNSIGNALS = turnSignals;
	}
	...
	public void onNeutralChanged(boolean neutral) {
		...
		Holder.shared().STORED_NEUTRAL = neutral;
	}
	...
	public void onCheckEngineChanged(boolean checkEngine) {
		...
		Holder.shared().STORED_CHECKENGINE = checkEngine;
	}
	...
	public void onOdometerImperialChanged(int odometer) {
		...
		Holder.shared().STORED_ODOMETER_IMPERIAL = odometer;
	}
	...
	public void onOdometerMetricChanged(int odometer) {
		...
		Holder.shared().STORED_ODOMETER_METRIC = odometer;
	}
	...
	public void onFuelImperialChanged(int fuel) {
		...
		Holder.shared().STORED_FUEL_IMPERIAL = fuel;
	}
	...
	public void onFuelMetricChanged(int fuel) {
		...
		Holder.shared().STORED_FUEL_METRIC = fuel;
	}
	...
	public void onFuelAverageImperialChanged(int fuel) {
		...
		Holder.shared().STORED_FUEL_AVERAGE_IMPERIAL = fuel;
	}
	...
	public void onFuelAverageMetricChanged(int fuel) {
		...
		Holder.shared().STORED_FUEL_AVERAGE_METRIC = fuel;
	}
	...
	public void onFuelInstantImperialChanged(int fuel) {
		...
		Holder.shared().STORED_FUEL_INSTANT_IMPERIAL = fuel;
	}
	...
	public void onFuelInstantMetricChanged(int fuel) {
		...
		Holder.shared().STORED_FUEL_INSTANT_METRIC = fuel;
	}
	...
	public void onVINChanged(String vin) {
		Holder.shared().STORED_VIN = vin;
	}

	@Override
	public void onECMPNChanged(String ecmPN) {
		Holder.shared().STORED_ECM_PN = ecmPN;
	}

	@Override
	public void onECMCalIDChanged(String ecmCalID) {
		Holder.shared().STORED_ECM_CALL_ID = ecmCalID;
	}

	@Override
	public void onECMSWLevelChanged(int swLevel) {
		Holder.shared().STORED_ECM_SW_LEVEL = swLevel;
	}

	@Override
	public void onHistoricDTCChanged(String[] dtc) {
		Holder.shared().STORED_HISTORIC_DTC = Arrays.asList(dtc);
	}

	@Override
	public void onCurrentDTCChanged(String[] dtc) {
		Holder.shared().STORED_CURRENT_DTC = Arrays.asList(dtc);
	}
